...
const BottomGradient: React.FC<BottomGradientProps> = ({ className }) => {
  return (
    <>
      ...
      <span className={cn("absolute inset-x-10 -bottom-px mx-auto block h-px w-1/2 bg-gradient-to-r from-transparent via-indigo-500 to-transparent opacity-0 blur-sm transition duration-500 group-hover/btn:opacity-100", className)} />
    </>
  );
};
